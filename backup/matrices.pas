...
interface
 ...
 type TMatrices = class
    ...
    function ejecutar(C:TMatrices;B:TMatrices;d:real):TMatrices;
...
function TMatrices.ejecutar(C:TMatrices;B:TMatrices;d:real): TMatrices;
begin
     case MetodoType of
       F_sum: Result:= MSuma(B);
       F_rest: Result:= MResta(B);
       F_mul : Result:= MMultiplicacion(C,B);
       F_mule : Result:= MMultEscalar(B,d);
       F_tra : Result:= MTranspuesta(B);
       //F_sub : Result:= MSubMatriz(B,i,j);
       //F_det : Result:= MDeterminante(B);
       F_adj : Result:= MAdjunta(B);
       F_inv : Result:= MInversa(B);
     end;
end;
